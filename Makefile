...
k-setup:
	minikube -p dev.to start --cpus 2 --memory=2048; \ # reduzido para rodar no meu notebook
...
k-cache-image:
    # não funcionou pra mim, foi necessário usar "minikube -p dev.to cache add java-k8s:latest"
